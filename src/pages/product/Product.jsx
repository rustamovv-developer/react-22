...
const Product = () => {
  const { id } = useParams();
  const { data, error } = useGetProductSingleQuery(id);
  ...
  let relatedProducts = allData?.slice(-4).map((el) => (
    <div key={el.id} className="products__card">
      <div className="products__box">
        <img className="products__img" src={el.image} alt={el.title} />
        <div className="products__icons">
          <Link className="products__icon">
      ...
      <div className="container">
        ...
        <div className="product__info">
          ...
          <div className="product__center">
            ...
            <div className="product__center__exam">
              <img src={stars} alt="stars" className="product__center__stars" />
            ...
            <div className="product__center__exem">
              ...
              <div className="product__center__off">
                <h3 className="product__center__oldprice">${data?.oldPrice}</h3>
            ...
            <div className="product__center__quan">
              ...
              <div className="product__center__end">
                <div className="product__center__add">
                  <IoCartOutline
                    className="product__center__icon"
                    style={{ color: "#33A0FF", fontSize: "20px" }}
                  />
                  <p className="product__center__addtocart">Add To Cart</p>
                </div>
          ...
          <div className="product__right">
            ...
            <img src={img3} alt="right__img" className="product__right__img" />
            <img src={stars} alt="stars" className="product__right__stars" />
        ...
        <div className="product__bottom">
          ...
          <p className="product__bottom__text">
            ...
            are and will always be one of my favorites. <br /> <br />
            air max are always very comfortable fit, clean and just perfect in
            every way. just the box was too small and scrunched the sneakers up
            a little bit, not sure if the box was always this small but the 90s
            are and will always be one of my favorites. <br /> <br />
